...
const MVPClubWebsite = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#faf5f0', fontFamily: 'Inter, system-ui, sans-serif' }}>
      {/* Google Fonts */}
      <style>{`
          ...
          <div className="hidden lg:flex items-center gap-8">
            {sections.slice(1, -1).map((section) => (
              <button
                ...
                className="text-sm font-medium transition-colors duration-200 hover:text-[#fbbf24]"
                style={{
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div 
            ...
            style={{ backgroundColor: '#d97706', animationDelay: '-2s' }}
          />
        </div>
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    >
                      <Users size={28} style={{ color: '#1a365d' }} />
                    </div>
                  ...
                  <div className="flex items-center gap-6">
                    <div 
                      ...
                      style={{ backgroundColor: '#115e59' }}
                    >
                      <Sparkles size={28} style={{ color: '#fbbf24' }} />
                    </div>
                    <div className="flex-1">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="font-display text-3xl md:text-4xl mb-6" style={{ color: '#1a365d' }}>
            ...
            {[
              ...
              <AnimatedSection key={i} delay={i * 100}>
                ...
                >
                  ...
                  <div className="font-semibold mb-2" style={{ color: '#1a365d' }}>
                    {item.label}
                  </div>
          ...
          <AnimatedSection>
            ...
            >
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <h3 className="font-display text-2xl mb-4" style={{ color: '#1a365d' }}>
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 font-semibold" style={{ color: '#1a365d' }}>AI Systems</div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="flex-1 text-right text-gray-500">User operates tool</div>
                      <ArrowRight size={16} style={{ color: '#d97706' }} />
                      <div className="flex-1 font-semibold" style={{ color: '#1a365d' }}>Manager collaborates</div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="flex-1 text-right text-gray-500">One-time training</div>
                      <ArrowRight size={16} style={{ color: '#d97706' }} />
                      <div className="flex-1 font-semibold" style={{ color: '#1a365d' }}>Continuous practice</div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="flex-1 text-right text-gray-500">Predictable outputs</div>
                      <ArrowRight size={16} style={{ color: '#d97706' }} />
                      <div className="flex-1 font-semibold" style={{ color: '#1a365d' }}>Creative potential</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Philosophy Section */}
      <section id="philosophy" className="py-24" style={{ backgroundColor: '#115e59' }}>
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <p 
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div 
                    ...
                    style={{ backgroundColor: '#fbbf24' }}
                  >
                    <Users size={24} style={{ color: '#1a365d' }} />
                  </div>
                  <div>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      <CheckCircle2 size={18} style={{ color: '#fbbf24' }} className="flex-shrink-0 mt-0.5" />
            ...
            <AnimatedSection delay={200}>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div 
                    className="w-14 h-14 rounded-xl flex items-center justify-center"
                    style={{ backgroundColor: '#115e59', border: '2px solid #fbbf24' }}
                  >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={i} className="flex items-start gap-3">
                      <Zap size={18} style={{ color: '#fbbf24' }} className="flex-shrink-0 mt-0.5" />
                      <span className="text-white/90">{item}</span>
                    </div>
                  ))}
                </div>
            ...
            {[
              ...
              <AnimatedSection key={i} delay={i * 100}>
                <div className="text-center">
                  ...
                  >
                    <principle.icon size={24} style={{ color: '#fbbf24' }} />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 flex justify-center">
                ...
                >
                  ...
                  <span className="font-medium" style={{ color: '#1a365d' }}>
          ...
          <AnimatedSection>
            <div className="mt-16 grid md:grid-cols-2 gap-8 items-center">
              ...
              >
                <div className="font-display text-lg mb-4" style={{ color: '#115e59' }}>
                ...
                <div 
                  ...
                  style={{ backgroundColor: '#115e59', color: '#fbbf24' }}
                >
      ...
      <section id="organizations" className="py-24" style={{ backgroundColor: '#1a365d' }}>
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="flex items-center gap-3 mb-4">
              <Building2 size={24} style={{ color: '#fbbf24' }} />
              <p 
                  ...
                  <div className="space-y-2">
                    {phase.activities.map((activity, j) => (
                      <div key={j} className="flex items-start gap-2">
                        <CheckCircle2 size={14} style={{ color: '#5a8a7a' }} className="flex-shrink-0 mt-0.5" />
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4">
                      <div 
                        ...
                        style={{ backgroundColor: 'rgba(251, 191, 36, 0.2)' }}
                      >
                        <outcome.icon size={20} style={{ color: '#fbbf24' }} />
                      </div>
      ...
      <section id="practitioners" className="py-24" style={{ backgroundColor: '#f0fdfa' }}>
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="flex items-center gap-3 mb-4">
              <GraduationCap size={24} style={{ color: '#115e59' }} />
              <p 
                className="text-sm font-semibold uppercase tracking-wider"
                style={{ color: '#115e59' }}
              >
            ...
            <h2 className="font-display text-3xl md:text-4xl mb-6 max-w-2xl" style={{ color: '#1a365d' }}>
              ...
              <AnimatedSection key={i} delay={i * 100}>
                <div className="card-hover bg-white p-8 rounded-2xl h-full">
                  <div 
                    ...
                    style={{ backgroundColor: '#f0fdfa' }}
                  >
                    <offering.icon size={28} style={{ color: '#115e59' }} />
                  </div>
                  <h3 className="font-display text-xl mb-3" style={{ color: '#1a365d' }}>
                    {offering.title}
                  </h3>
                  ...
                  <div className="space-y-2">
                    {offering.features.map((feature, j) => (
                      <div key={j} className="flex items-start gap-2">
                        <CheckCircle2 size={16} style={{ color: '#115e59' }} className="flex-shrink-0 mt-0.5" />
          ...
          <AnimatedSection>
            ...
            >
              ...
              <button
                onClick={() => scrollToSection('contact')}
                className="px-8 py-4 rounded-lg font-semibold transition-all duration-200 hover:scale-105"
                style={{ backgroundColor: '#fbbf24', color: '#1a365d' }}
              >
                Join the Community
              </button>
            </div>
              ...
              <AnimatedSection key={i} delay={i * 100}>
                <div className="card-hover bg-white p-8 rounded-2xl text-center h-full">
                  ...
                  <div 
                    ...
                    style={{ backgroundColor: i === 0 ? '#1a365d' : i === 1 ? '#115e59' : '#5a8a7a' }}
                  >
                    <Users size={40} style={{ color: '#fbbf24' }} />
                  </div>
                  <h3 className="font-display text-xl mb-1" style={{ color: '#1a365d' }}>
                    {member.name}
                  </h3>
                  <p className="text-sm mb-4" style={{ color: '#115e59' }}>{member.role}</p>
                  ...
                  <div className="flex flex-wrap justify-center gap-2">
                    {member.expertise.map((skill, j) => (
                      <span 
                        ...
                        style={{ backgroundColor: '#f0fdfa', color: '#115e59' }}
                      >
                        {skill}
                      </span>
                    ))}
      ...
      <section id="testimonials" className="py-24" style={{ backgroundColor: '#eff6ff' }}>
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <p 
            ...
            >
              {[
                ...
                <div key={i} className="text-center">
                  <div className="font-display text-3xl mb-1" style={{ color: '#fbbf24' }}>
                    {item.stat}
                  </div>
            ...
            {[
              ...
              <AnimatedSection key={i} delay={i * 100}>
                <div className="card-hover bg-white p-6 rounded-xl h-full flex flex-col">
                  <Quote size={24} style={{ color: '#d97706' }} className="mb-4 opacity-50" />
                  <p className="text-gray-700 mb-6 flex-grow leading-relaxed">
                    "{testimonial.quote}"
                  </p>
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div>
                      <div className="font-semibold text-sm" style={{ color: '#1a365d' }}>
                        {testimonial.name}
                      </div>
      ...
      {/* CTA Section */}
      <section id="contact" className="py-24" style={{ backgroundColor: '#115e59' }}>
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            ...
            <AnimatedSection delay={100}>
              <div className="bg-white p-8 rounded-2xl h-full flex flex-col">
                <div 
                  ...
                  style={{ backgroundColor: '#eff6ff' }}
                >
                  <Building2 size={28} style={{ color: '#1a365d' }} />
                </div>
                <h3 className="font-display text-xl mb-3" style={{ color: '#1a365d' }}>
                  For Organizations
                </h3>
                ...
                <div className="space-y-3 mb-6">
                  {['30-minute discovery call', 'Custom scope assessment', 'No commitment required'].map((item, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <CheckCircle2 size={16} style={{ color: '#115e59' }} />
      ...
      {/* Footer */}
      <footer className="py-12" style={{ backgroundColor: '#1a365d' }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="font-display text-xl" style={{ color: '#fbbf24' }}>
              MVP Club Consulting
            </div>
